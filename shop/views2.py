...
@api_view(['POST'])
# views.py - modify your update_cart_item view
...
def checkout(request):
    ...
    if request.method == 'POST':
        ...
        request.session['shipping_address'] = shipping_address
        request.session['shipping_city'] = city
        request.session['shipping_state'] = state  # Fixed: Correct field
        request.session['shipping_pincode'] = pincode
        
        request.session['available_item_ids'] = [item.id for item in available_items]
